...
var EXAM_TYPES = [['ca_notary', 'California Notary', 'CA', 'Notary'],
  ...
  ['ca_real_estate', 'California Real Estate (Salesperson)', 'CA', 'Real Estate'],
  ...
  ['ak_real_estate', 'Alaska Real Estate', 'AK', 'Real Estate'],
  ['al_real_estate', 'Alabama Real Estate', 'AL', 'Real Estate'],
  ['ar_real_estate', 'Arkansas Real Estate', 'AR', 'Real Estate'],
  ['az_real_estate', 'Arizona Real Estate', 'AZ', 'Real Estate'],
  ['co_real_estate', 'Colorado Real Estate', 'CO', 'Real Estate'],
  ['ct_real_estate', 'Connecticut Real Estate', 'CT', 'Real Estate'],
  ['de_real_estate', 'Delaware Real Estate', 'DE', 'Real Estate'],
  ['hi_real_estate', 'Hawaii Real Estate', 'HI', 'Real Estate'],
  ['ia_real_estate', 'Iowa Real Estate', 'IA', 'Real Estate'],
  ['id_real_estate', 'Idaho Real Estate', 'ID', 'Real Estate'],
  ['in_real_estate', 'Indiana Real Estate', 'IN', 'Real Estate'],
  ['ks_real_estate', 'Kansas Real Estate', 'KS', 'Real Estate'],
  ['ky_real_estate', 'Kentucky Real Estate', 'KY', 'Real Estate'],
  ['la_real_estate', 'Louisiana Real Estate', 'LA', 'Real Estate'],
  ['ma_real_estate', 'Massachusetts Real Estate', 'MA', 'Real Estate'],
  ['md_real_estate', 'Maryland Real Estate', 'MD', 'Real Estate'],
  ['me_real_estate', 'Maine Real Estate', 'ME', 'Real Estate'],
  ['mn_real_estate', 'Minnesota Real Estate', 'MN', 'Real Estate'],
  ['mo_real_estate', 'Missouri Real Estate', 'MO', 'Real Estate'],
  ['ms_real_estate', 'Mississippi Real Estate', 'MS', 'Real Estate'],
  ['mt_real_estate', 'Montana Real Estate', 'MT', 'Real Estate'],
  ['nd_real_estate', 'North Dakota Real Estate', 'ND', 'Real Estate'],
  ['ne_real_estate', 'Nebraska Real Estate', 'NE', 'Real Estate'],
  ['nh_real_estate', 'New Hampshire Real Estate', 'NH', 'Real Estate'],
  ['nj_real_estate', 'New Jersey Real Estate', 'NJ', 'Real Estate'],
  ['nm_real_estate', 'New Mexico Real Estate', 'NM', 'Real Estate'],
  ['nv_real_estate', 'Nevada Real Estate', 'NV', 'Real Estate'],
  ['ok_real_estate', 'Oklahoma Real Estate', 'OK', 'Real Estate'],
  ['or_real_estate', 'Oregon Real Estate', 'OR', 'Real Estate'],
  ['ri_real_estate', 'Rhode Island Real Estate', 'RI', 'Real Estate'],
  ['sc_real_estate', 'South Carolina Real Estate', 'SC', 'Real Estate'],
  ['sd_real_estate', 'South Dakota Real Estate', 'SD', 'Real Estate'],
  ['tn_real_estate', 'Tennessee Real Estate', 'TN', 'Real Estate'],
  ['ut_real_estate', 'Utah Real Estate', 'UT', 'Real Estate'],
  ['vt_real_estate', 'Vermont Real Estate', 'VT', 'Real Estate'],
  ['wi_real_estate', 'Wisconsin Real Estate', 'WI', 'Real Estate'],
  ['wv_real_estate', 'West Virginia Real Estate', 'WV', 'Real Estate'],
  ['wy_real_estate', 'Wyoming Real Estate', 'WY', 'Real Estate'],
